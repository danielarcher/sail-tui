...
const HELP_KEYS = [
    ...
    { key: 'F',                   action: 'Fix Laravel — clear compiled views + optimize:clear' },
    { key: 'Shift + U/D/S/R/H',   action: 'Same actions, but applied to every project' },
    { key: 'l',                   action: 'Cycle log tabs (Vite → Reverb → Queue → Laravel → Tests)' },
    { key: '← / →',               action: 'Horizontal scroll of log lines (no wrap)' },
    { key: '0',                   action: 'Reset horizontal scroll to column 0' },
    { key: 'G / End',             action: 'Jump to the end of the log, resume follow, reset scroll' },
